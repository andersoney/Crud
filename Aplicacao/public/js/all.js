...
inicioMapa = function inicioMapa() {
...
reinicioMapa = function reinicioMapa($n) {
	$.get('/getData', function ($dota) {
		//console.log($dota);
		this.data = $dota;
		for (var i = 0; i < data.length; i++) {
...
deletedSucesso = function deletedSucesso(msg) {
	console.log("Data Deleted: ");
	console.log(msg);
};
deletedErro = function deletedErro(msg) {
